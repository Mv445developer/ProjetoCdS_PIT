  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UserCreditCardRow:
            return UserCreditCardRow(data);
          case ShpoCartRow:
            return ShpoCartRow(data);
          case UserAdressRow:
            return UserAdressRow(data);
          case ProductsRow:
          ...
          case AdressInfoRow:
            return AdressInfoRow(data);
          case ProductInfoRow:
            return ProductInfoRow(data);
          case UserAdressDefautRow:
            return UserAdressDefautRow(data);
          case UserCreditCardDefautRow:
            return UserCreditCardDefautRow(data);
          default:
            return null;
        }
