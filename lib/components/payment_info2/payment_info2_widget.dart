...
import 'payment_info2_model.dart';
export 'payment_info2_model.dart';

class PaymentInfo2Widget extends StatefulWidget {
  const PaymentInfo2Widget({super.key});

  @override
  _PaymentInfo2WidgetState createState() => _PaymentInfo2WidgetState();
}

class _PaymentInfo2WidgetState extends State<PaymentInfo2Widget>
    with TickerProviderStateMixin {
  late PaymentInfo2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentInfo2Model());
                                      ...
                                      await UserCreditCardDefautTable().update(
                                        data: {
                                          ...
                                          'validation':
                                              listViewUserCreditCardRow
                                                  .validation,
                                          'cvv': listViewUserCreditCardRow.cvv,
                                          'defaut': true,
                                        },
