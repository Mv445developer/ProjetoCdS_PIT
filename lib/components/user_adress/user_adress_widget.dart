...
export 'user_adress_model.dart';

class UserAdressWidget extends StatefulWidget {
  const UserAdressWidget({super.key});

  @override
  _UserAdressWidgetState createState() => _UserAdressWidgetState();
}

class _UserAdressWidgetState extends State<UserAdressWidget>
    with TickerProviderStateMixin {
  late UserAdressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserAdressModel());
